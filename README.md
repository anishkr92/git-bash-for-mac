...
```shell
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/anishkr92/git-bash-for-mac/master/install.sh)"
```
...
1. from the `Terminal`, run
```shell
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/anishkr92/git-bash-for-mac/master/uninstall.sh)"
```
